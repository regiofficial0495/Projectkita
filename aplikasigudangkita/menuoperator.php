...
<html lang="en">
<head>
  <title>SIM Gudang  - Menu Utama</title>
  <meta charset="utf-8">
...
<body>
<h2 class="text-center bg-warning text-primary">SIM Gudang kita 2024</h2>
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="menuutama.php"><img src="images/umb.png" width="50px" height="50px"></a>
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" href="menuoperator.php">Beranda</a>
        </li>
        <li class="nav-item">
